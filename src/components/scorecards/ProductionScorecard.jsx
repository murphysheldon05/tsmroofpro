    ...
    <div className="min-h-screen bg-gray-50 p-4">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-4 mb-4">
          ...
          <textarea value={notes} onChange={(e) => setNotes(e.target.value)} rows={3} placeholder="Feedback, job site observations, action items..." className="w-full mt-1 px-3 py-2 text-sm border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-emerald-400 resize-none" />
        </div>
