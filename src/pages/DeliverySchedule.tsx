...
import { ChevronLeft, ChevronRight, Plus, Pencil, Trash2, X, GripVertical, Users, Filter, Truck } from "lucide-react";
      ...
      <div className="space-y-6">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-muted-foreground">Material delivery scheduling calendar</p>
          </div>
        </div>
                      ...
                      {dayEvents.slice(0, 2).map((event) => {
                        ...
                        return (
                          <div
                            ...
                            title={`${event.crew_id ? getCrewName(event.crew_id) : "Unassigned"}: ${event.title}${canEdit ? " (drag to reschedule)" : ""}`}
                          >
