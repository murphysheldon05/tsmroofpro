// Master Operating Playbook SOP Data
// This is the source of truth for the 10 Master SOPs that require acknowledgment

export const NEON_GREEN = '#00D26A';
export const NEON_GREEN_LIGHT = '#00FF85';
export const NEON_GREEN_DARK = '#00B85C';
...
export const MASTER_SOPS: MasterSOP[] = [
  {
    ...
    flowSteps: [
      ...
      { label: 'Accounting Executes', type: 'process', owner: 'Accounting', note: '' },
      { label: 'Commission Processed', type: 'end', owner: 'System', note: '' }
    ],
    rules: [
  ...
  },
  {
    ...
    flowSteps: [
      { label: 'Production Complete', type: 'start', owner: 'Production', note: '' },
      ...
      { label: 'Payment Collection', type: 'process', owner: 'Sales/Supplements', note: '' },
      { label: 'Job Closed', type: 'end', owner: 'Accounting', note: '' }
    ],
    rules: [
  ...
  },
  {
    ...
    flowSteps: [
      ...
      { label: 'Xactimate Build', type: 'process', owner: 'Supplements', note: '' },
      { label: 'Carrier Submission', type: 'process', owner: 'Supplements', note: '' },
      { label: 'Supplements Issues Invoice', type: 'end', owner: 'Supplements', note: '' }
    ],
    rules: [
  ...
  },
  {
    ...
    flowSteps: [
      { label: 'SOP Published/Updated', type: 'start', owner: 'Ops Compliance', note: '' },
      { label: 'User Notification Sent', type: 'process', owner: 'System', note: '' },
      { label: 'Acknowledgment Check', type: 'decision', owner: 'System', branches: ['Not Acknowledged → Block', 'Acknowledged → Grant Access'] },
      { label: 'User Executes Actions', type: 'process', owner: 'User', note: '' },
      { label: 'Enforcement Action', type: 'end', owner: 'Ops Compliance', note: '' }
    ],
    rules: [
  ...
  },
  {
    ...
    flowSteps: [
      { label: 'User Account Created', type: 'start', owner: 'HR', note: '' },
      { label: 'Role Assigned', type: 'process', owner: 'HR/Admin', note: '' },
  ...
  },
  {
    ...
    flowSteps: [
      { label: 'Access Request Submitted', type: 'start', owner: 'HR', note: '' },
      { label: 'Role Assigned', type: 'process', owner: 'HR', note: '' },
      { label: 'SOP Acknowledgment Required', type: 'decision', owner: 'System', branches: ['Not Complete → Blocked', 'Complete → Continue'] },
      { label: 'Access Activated', type: 'process', owner: 'System', note: '' },
      { label: 'Compliance Audit', type: 'end', owner: 'Ops Compliance', note: '' }
    ],
    rules: [
  ...
  },
  {
    ...
    flowSteps: [
      ...
      { label: 'Document in AccuLynx', type: 'process', owner: 'Initiator', note: '' },
      { label: 'Approval Recognized', type: 'end', owner: 'System', note: '' }
    ],
    rules: [
  ...
  },
  {
    ...
    flowSteps: [
      { label: 'Status/Data Change Requested', type: 'start', owner: 'User', note: '' },
      ...
      { label: 'Change Applied & Logged', type: 'end', owner: 'System', note: '' }
    ],
    rules: [
  ...
  },
  {
    ...
    flowSteps: [
      { label: 'Commission Approved', type: 'start', owner: 'Sales Manager', note: '' },
      ...
      { label: 'Added to Friday Payroll', type: 'end', owner: 'Accounting', note: '' }
    ],
    rules: [
  ...
  },
  {
    ...
    flowSteps: [
      { label: 'Job Approved for Production', type: 'start', owner: 'Sales/Manager', note: '' },
      { label: 'Readiness Checklist', type: 'decision', owner: 'System', branches: ['Not 100% → Blocked', '100% → Continue'] },
      { label: 'Schedule Production Date', type: 'process', owner: 'Production Manager', note: '' },
      { label: 'Build Executed', type: 'process', owner: 'Production Crew', note: '' },
      { label: 'Job Completed', type: 'end', owner: 'Production', note: '' }
    ],
    rules: [
